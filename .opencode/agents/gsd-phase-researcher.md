...
@/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/references/thinking-models-research.md
...
```bash
node "/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
