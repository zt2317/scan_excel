...
- Usage: Reference from command with `@/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/zhangtao/Work/py/scan_excel/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/zhangtao/Work/py/scan_excel/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
