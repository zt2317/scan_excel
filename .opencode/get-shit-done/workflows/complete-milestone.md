...
```bash
node "/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/templates/retrospective.md`.
