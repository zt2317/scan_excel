...
- **Global scope**: `/Users/zhangtao/Work/py/scan_excel/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/zhangtao/Work/py/scan_excel/.opencode/notes/`)
...
2. Glob `/Users/zhangtao/Work/py/scan_excel/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/zhangtao/Work/py/scan_excel/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/zhangtao/Work/py/scan_excel/.opencode/notes/` — works in any directory
