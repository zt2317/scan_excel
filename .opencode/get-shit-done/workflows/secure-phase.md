...
```
Task(
  prompt="Read /Users/zhangtao/Work/py/scan_excel/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/templates/SECURITY.md`
