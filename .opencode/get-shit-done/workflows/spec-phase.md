...
```bash
INIT=$(node "/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/templates/spec.md.
