...
```
Task(
  prompt="Read /Users/zhangtao/Work/py/scan_excel/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/zhangtao/Work/py/scan_excel/.opencode/get-shit-done/templates/VALIDATION.md`
